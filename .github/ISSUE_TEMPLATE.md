...
This issue tracker is only for technical issues related to ZID Core.
General ZID questions and/or support requests and are best directed to the [ZID Slack](http://zid.slack.com).
...
### What version of ZID Core are you using?
