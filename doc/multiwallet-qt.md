...
In order to support loading of multiple wallets in zid-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zid.cpp.
...
Changes to zid.cpp
----------------------
zid.cpp is the entry point into zid-qt, and as such, will require some minor modifications to provide hooks for
