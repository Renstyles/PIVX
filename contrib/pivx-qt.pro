...
RESOURCES += src/qt/zid.qrc src/qt/zid_locale.qrc

TRANSLATIONS += src/qt/locale/zid_bg.ts \
                src/qt/locale/zid_de.ts \
                src/qt/locale/zid_en.ts \
                src/qt/locale/zid_es.ts \
                src/qt/locale/zid_fi.ts \
                src/qt/locale/zid_fr.ts \
                src/qt/locale/zid_it.ts \
                src/qt/locale/zid_ja.ts \
                src/qt/locale/zid_pl.ts \
                src/qt/locale/zid_pt.ts \
                src/qt/locale/zid_ru.ts \
                src/qt/locale/zid_sk.ts \
                src/qt/locale/zid_sv.ts \
                src/qt/locale/zid_vi.ts \
                src/qt/locale/zid_zh_CN.ts \
                src/qt/locale/zid_zh_TW.ts
