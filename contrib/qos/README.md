...
This means one can have an always-on zidd instance running, and another local zidd/zid-qt instance which connects to this node and receives blocks from it.
