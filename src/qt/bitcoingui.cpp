                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZID Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZID address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zid: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZID Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZID Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZID"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZID addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZID addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZID: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZID Core help message to get a list with possible ZID command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZID Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZID network", "", count));
}
...
{
    QString strTitle = tr("ZID Core"); // default title
