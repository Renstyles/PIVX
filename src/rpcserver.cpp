...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zid features */
        {"zid", "masternode", &masternode, true, true, false},
        {"zid", "masternodelist", &masternodelist, true, true, false},
        {"zid", "mnbudget", &mnbudget, true, true, false},
        {"zid", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zid", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zid", "mnsync", &mnsync, true, true, false},
        {"zid", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zid", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zidd, or the -server option to zid-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zid-cli " + methodname + " " + args + "\n";
}
