Contributing to ZID Core
============================

The ZID Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZID Core project, and is not to be
confused with overall ZID Network Protocol consensus changes.

Whether a pull request is merged into ZID Core rests with the project merge
...
Patches that change ZID consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZID consensus, it must have been
...
The project leader is the release manager for each ZID Core release.
